...
var system_constants ={
    ...
    EMPRESAS:[{ID:0,NOMBRE:"GUARD SERVICE SEGURIDAD S.A.",RUT:"79.960.660-7",BD_SOFTLAND:"GUARD"},{ID:1,NOMBRE:"GUARD SERVICE TECNOLOGIAS S.A.",RUT:"76.924.640-1",BD_SOFTLAND:"TECNOLOGIASSA22"},{ID:2,NOMBRE:"GS OUTSOURCING S.A.",RUT:"76.924.640-1",BD_SOFTLAND:"OUTSOURCINGSA"},{ID:3,NOMBRE:"ODIN",RUT:"76.005.383-K",BD_SOFTLAND:"ODINLTDA"}],
    ...
    TABLE_NOMINAS_BANCARIAS_POR_PERSONA:{database:'SISTEMA_CENTRAL', table:'bi_liquidaciones_nominas_por_persona'}
}
