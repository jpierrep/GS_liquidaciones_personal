 ...
 */
  ...
  res.render("../views/controla_proceso_file_project", { hola: "hola" });
...
io.on('connection', (socket) => {
  ...
  socket.on('getLiquidacionesFileProject', async (dataUser) => {
   console.log("en testing fileproject")
  ...
  api.get("/vistaProcesos_file_project", function (req, res) {
...
socket.emit('getGlobalAlert', {messaje:"Error, no es posible generar el proceso para el mes solicitado",type:'error'})
  ...
  /*************************+DIR DESTINO  PARA GUARDAR ARCHVIO
